...
<%
    ...
    List visits = mgr.listPharmordersByStatus("Pharmacy");
                        ...
                        <div class="span9 thumbnail well content">
                            ...
                            <table class="example display table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="dialog" id="<%=vst.getPatientid()%>_dialog" title=" <img src='images/danpongclinic.png' width='120px;'  class='pull-right' style='margin-top: 30px; padding: 0px;' />">
                                                ...
                                                <div style="font-weight: bolder;" class="lead center"> <u> DISPENSARY INVOICE </u> </div>
                                                <div style="max-height: 400px; overflow-y: scroll;" class="center thumbnail">
                                                    ...
                                                    <form action="action/forwardaction.jsp" method="post">
                                                        <table class="table">
                                                            <thead>
                                                                <tr style="color: #fff;">
                                                                    <th rowspan="2" style="color: #fff;"> Drug </th>
                                                                    <th  rowspan="2" style="color: #fff;"> Type </th>
                                                                    <th rowspan="2" style="color: #fff;"> Dosage </th>
                                                                    <th rowspan="2" style="color: #fff;"> Quantity</th>                                                                
                                                                    <th rowspan="2" style="color: #fff;"> Unit Cost </th>
                                                                    <th rowspan="2" style="color: #fff;"> Total </th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <%
                                                                    ...
                                                                    for (int r = 0; r < ptreatmentss.size(); r++) {
                                                                       ...
                                                                       if(mgr.getTreatment(ptPatienttreatments.getTreatmentid()).getQuantity()>0){ 
                                                                %>
                                                                <tr>
                                                                    <td class="treatment_row<%=vst.getOrderid()%><%=ptPatienttreatments.getTreatmentid()%>"><%=mgr.getTreatment(ptPatienttreatments.getTreatmentid()).getTreatment()%> </td>
                                                                    <td class="treatment_row<%=vst.getOrderid()%><%=ptPatienttreatments.getTreatmentid()%>"> <%=ptPatienttreatments.getType()%>  </td>
                                                                    <td class="treatment_row<%=vst.getOrderid()%><%=ptPatienttreatments.getTreatmentid()%>" style="text-transform: capitalize;"><%=ptPatienttreatments.getDosage().split("_")[1]%>  </td>

                                                                    <td class="treatment_row<%=vst.getOrderid()%><%=ptPatienttreatments.getTreatmentid()%>" style="text-align: center;"> <%=ptPatienttreatments.getQuantity()%> </td>

                                                                    <td class="treatment_row<%=vst.getOrderid()%><%=ptPatienttreatments.getTreatmentid()%>" style="text-align: right;"><%=df.format(ptPatienttreatments.getPrice())%> </td>
                                                                    <td class="treatment_row<%=vst.getOrderid()%><%=ptPatienttreatments.getTreatmentid()%>" style="text-align: right;"><%= df.format((ptPatienttreatments.getQuantity() * ptPatienttreatments.getPrice()))%>
                                                                ...
                                                                <%}else{%>
                                                                <tr>
                                                                    <td><span style="color: #FF4242"><%=mgr.getTreatment(ptPatienttreatments.getTreatmentid()).getTreatment()%> is out of stock</span></td>
                                                                </tr>
                                                                <%}}
                                                                    %> 
                                                                <tr>
                                                                                    ...
                                                                                    <table style="width: 100%" cellspacing="0">
                                                                                        ...
                                                                                        <tbody style="font: 12px lighter;  font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;">
                                                                                            <% 
                                                                                                ...
                                                                                                List ptreatmentss2 = mgr.patientTreatment(vst.getVisitid());
