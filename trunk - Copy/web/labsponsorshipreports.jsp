...
<html>
    <head>
        ...
        <%
            ...
            List<PaymentObject> allPayments = mgr.listAllPayments();
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <!-- <td style="text-align: center;"> 
                                            <a class="btn btn-info btn-small" href="labsponsordetails.jsp?sponsorid=<%=sponsor.getSponshorshipid()%>">View Details </a> 
                                        </td>  -->
                                    </tr>
