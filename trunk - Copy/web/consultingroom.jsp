                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="radioset">
                                        ...
                                        %>
                                        <input type="radio" id="age1<%=clerkinganswer.getAnswerid()%>" name="ans<%=clerkingquestion.getClerkid()%>" value="<%=clerkingquestion.getClerkid()%>_<%=clerkinganswer.getAnswerid()%> "/><label for="age1<%=clerkinganswer.getAnswerid()%>"><%=clerkinganswer.getAnswer()%></label>
