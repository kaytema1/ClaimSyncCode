                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-small" id="<%=itt.getRequisitionid()%>_post">
                                                Action
                                            </button>
                                            <div class="dialog" id="<%=itt.getRequisitionid()%>_postdialog" title="Accept or Reject Item">
                                                <table>
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><% Treatment t1 = (Treatment) mgr.getTreatment(table.getBatchNumber());
                                                            if (t1 != null) {%>
