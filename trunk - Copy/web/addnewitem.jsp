                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div style="display: none; max-height: 500px;" id="<%=stockItems.getCode()%>_dialog" title="Editing <%=stockItems.getDescription()%>">
                                                <form class="form-horizontal" action="action/additem.jsp" method="post" name="">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="code" id="icd10_<%=stockItems.getIcd10()%>" value="<%=stockItems.getIcd10()%>" disabled="disabled">
                                                            <p class="help-block"></p>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
...
<div class="control-group">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="code" id="qty_<%=stockItems.getCode()%>" value="<%=stockItems.getQunaity()%>"/>
                                                            <p class="help-block"></p>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="code" id="reorder_<%=stockItems.getCode()%>" value="<%=stockItems.getReOrderLevel()%>"/>
                                                            <p class="help-block"></p>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="code" id="emergency_<%=stockItems.getCode()%>" value="<%=stockItems.getEmergencyLevel()%>"/>
                                                            <p class="help-block"></p>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
