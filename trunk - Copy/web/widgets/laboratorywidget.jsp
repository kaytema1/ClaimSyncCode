    ...
    <ul style="display: none;"  class="menu hide">
        ...
        <li class="item1">
            ...
            <ul>
                ...
                <%}%>
                <li class="subitem2">
                    <a href="listlabpatients.jsp">Update Patient Details <span><%=labPatients.size()%></span> </a>
                </li> 
        ...
        <li class="item4">
            <a href="#"><i class="icon-picture"></i> Statistics & Reports  </a>
            <ul>
                <!--li class="subitem2">
                ...
                <li class="subitem1">
                    <a href="paymenttypesales.jsp">Payment Type Sales Report</a>
                </li>
                <li class="subitem2">
                ...
                <li class="subitem2">
                    <a href="labpatienthistory.jsp">Patient History Report</a>
                </li>
                <%}%>
                ...
                <li class="subitem2">
                    <a href="labtestsoutstanding.jsp">Outstanding Tests Report</a>
                </li>
                <%}%>
                <% if (permissions.contains(80)) {%>
                <li class="subitem2">
                    <a href="laboutstandingpaymentsmade.jsp">Outstanding Payments Report</a>
                </li>
                <%}%>
                ...
                <li class="subitem2">
                    <a href="labsponsorshipreports.jsp">Sponsorship Report</a>
                </li>
                <%}%>
                ...
                <%}%>
                <!--  <li class="subitem2">
                   <a href="labutilization.jsp">Lab Reports Dashboard</a>
               </li>  -->
        ...
        <li class="item4">
            ...
            <ul>
                <li class="subitem2">
                    <a href="insurancesummarybystaff.jsp">Cash Analysis</a>
                </li>
        ...
        <li class="item4">
            ...
            <ul>
                ...
                <% if (permissions.contains(33) || permissions.contains(75)) {%>
                <li class="subitem1">
                    <a href="paymenttypesales.jsp">Payment Type Sales Report</a>
                </li>
                ...
                <%}%>
                <% if (permissions.contains(33) || permissions.contains(85)) {%>
                <li class="subitem2">
                    <a href="labreporttracking.jsp">Report Tracking</a>
                </li>
                <%}%>
                <% if (permissions.contains(33) || permissions.contains(76)) {%>
                <li class="subitem2">
                    <a href="labpatienthistory.jsp">Patient History Report</a>
                </li>
                <%}%>
                <% if (permissions.contains(33) || permissions.contains(77)) {%>
                <li class="subitem2">
                    <a href="labtestloadreports.jsp">Test Load Report</a>
                </li>
                <%}%>
                <% if (permissions.contains(33) || permissions.contains(78)) {%>
                <li class="subitem2">
                    <a href="labtestbooking.jsp">Test Booking Report</a>
                </li>
                <%}%>
                <% if (permissions.contains(33) || permissions.contains(79)) {%>
                <li class="subitem2">
                    <a href="labtestsoutstanding.jsp">Outstanding Tests Report</a>
                </li>
                <%}%>
                <% if (permissions.contains(33) || permissions.contains(80)) {%>
                <li class="subitem2">
                    <a href="laboutstandingpaymentsmade.jsp">Outstanding Payments Report</a>
                </li>
                <%}%>
                <% if (permissions.contains(33) || permissions.contains(81)) {%>
                <li class="subitem2">
                    <a href="laboutstandingpayments.jsp">Current Outstanding Bills</a>
                </li>
                <%}%>
                <% if (permissions.contains(33) || permissions.contains(82)) {%>
                <li class="subitem2">
                    <a href="labsponsorshipreports.jsp">Sponsorship Report</a>
                </li>
                <%}%>
                <% if (permissions.contains(33) || permissions.contains(83)) {%>
                <li class="subitem2">
                    <a href="labfacilityreferrals.jsp">Facility Referrals Report</a>
                </li>
                <%}%>
                <% if (permissions.contains(33) || permissions.contains(84)) {%>
                <li class="subitem2">
                    <a href="labdoctorreferrals.jsp">Doctors Referrals Report</a>
                </li>
                <%}%>
                
                <% if (permissions.contains(33) || permissions.contains(74)) {%>
                <li class="subitem2">
                    <a href="labpricelist.jsp">Laboratory Price List</a>
                </li>
                <%}%>
