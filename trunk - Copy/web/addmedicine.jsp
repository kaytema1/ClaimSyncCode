                            ...
                            <table class="example display">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <%=itemsTable.getNhisprice()%>
                                        </td>
                                        <td>
                                            <%=itemsTable.getPharmacyprice()%>
                                        </td>
                                        <td>
                                            <%=mgr.getTherapeuticGroup(mgr.getStockItem(itemsTable.getCode()).getTheragroup()).getDescription() %>
                                        </td>
                                        <td>
                                            <%=mgr.getGroups(mgr.getStockItem(itemsTable.getCode()).getGroupId()).getDescriptio()%>
                                        </td>

                                        <td>
                                           
                                            <button class="btn btn-primary" id="batch_<%=itemsTable.getBatchNumber()%>" onclick='submitform("<%=itemsTable.getBatchNumber()%>");return false'>
