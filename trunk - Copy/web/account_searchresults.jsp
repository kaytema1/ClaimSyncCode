...
<html lang="en">
                                            ...
                                            <div class="center thumbnail">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-transform: capitalize"><%=pT.getType()%></td>
    ...
    %>
                                    ...
                                    <td>
                                        <div style="max-height: 600px; y-overflow: scroll; display: none;"  id="<%= p.getPatientid()%>_dialog2"  title="Patient Information">
                                    ...
                                    <td>
                                        <div style="max-height: 600px; y-overflow: scroll; display: none;"  id="<%= p.getPatientid()%>_dialog3"  title="Patient Information">
                                            <div class="well thumbnail">
                                            </div>
                                        </div>
                                    </td>
