                                                ...
                                                <div class="well thumbnail">
                                                    ...
                                                    <form action="action/forwardaction.jsp" method="post">
                                                        <table class="table">
                                                            <thead>
                                                                <tr style="color: #FFF;">
                                                                    <th style="color: #FFF; text-align: left;"> Drug </th>
                                                                    <th style="color: #FFF; text-align: left;"> Form </th>
                                                                    <th style="color: #FFF; text-align: left;"> Dosage </th>
                                                                    <th style="color: #FFF; text-align: center;"> Quantity</th>                                                                
                                                                    <th style="color: #FFF; text-align: right;"> Unit Cost </th>
                                                                    <th style="color: #FFF; text-align: right;"> Total </th>
                                                                    <th style="color: #FFF; text-align: center;"> Status</th>
                                                                    <th style="color: #FFF; text-align: center;"> Dispensed</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <%%>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: center;"> <%=ptPatienttreatments.getQuantity()%> </td>
                                                                    ...
                                                                    <td style="text-align: center; width: 110px;">
                                                                        <label class="switch-container">
                                                                            <input type="checkbox" name="dispensed[]" value="<%=ptPatienttreatments.getId()%>" style="width: 100px" class="switch-input  hide">
                                                                            <div class="switch">
...
<!--  <input type="hidden" name="visitid" value="<%=ptPatienttreatments.getId()%>"/>
  <input type="hidden" name="visitid" value="<%=ptPatienttreatments.getId()%>"/>-->
                                                        ...
                                                        <div style="text-align: center;" class="form-actions">
                                                            ...
                                                            <button class="btn btn-danger" name="action" value="Forward to Accounts">
