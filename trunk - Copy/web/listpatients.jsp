                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="max-height: 600px; display: none" id="<%=patient.getPatientid()%>_dialog" title="<%=patient.getFname()%> <%=patient.getMidname()%> <%=patient.getLname()%>'s Profile">
                                                ...
                                                <form id="updateregistration<%=patient.getPatientid()%>" action="action/updateregistrationaction.jsp" method="POST" enctype="multipart/data"  class="form-horizontal well" style="padding-top: 40px;">
                                                    <fieldset>
                                                        ...
                                                        <div style="float: left; margin-top: -50px;" >
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" name="occupation"  class="input-medium" id="occupation" value="<%=patient.getOccupation() == null ? "N/A" : patient.getOccupation()%>"/>
                                                                    <span class="help-inline"></span>
                                                                </div>
                                                            </div>
                                                            <div class="control-group">
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" disabled="true"  class="input-medium" value="<%=mgr.sponsorshipDetails(patient.getPatientid()).getType()%>" />   
                                                                </div>
                                                            </div>
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    ...
                                                                    <input type="text" disabled="true"  class="input-medium" value="<%=mgr.getSponsor(mgr.sponsorshipDetails(patient.getPatientid()).getSponsorid()) == null ? mgr.sponsorshipDetails(patient.getPatientid()).getType() : mgr.getSponsor(mgr.sponsorshipDetails(patient.getPatientid()).getSponsorid()).getSponsorname()%>" />
                                                                </div>
                                                            </div>
