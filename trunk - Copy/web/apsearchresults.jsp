                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="display example table">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a class="btn btn-info btn-small appointment_link<%=p.getPatientid()%>" href="appointment.jsp"><i class="icon-white icon-pencil"></i> New Appointment </a>
                                    </td>
                                </tr>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="display example table">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                     <a class="btn btn-info btn-small appointment_link<%=pp.getPatientid()%>" href="appointment.jsp"><i class="icon-white icon-pencil"></i> New Appointment </a>
