...
%>
                                                    ...
                                                    <div class="form-actions center">
                                                        <button class="btn btn-info btn-small" href="" onclick='printSelection(document.getElementById("print"));
                                                                dispatch("<%=vst.getOrderid()%>");
                                                                return false'>
                                    ...
                                    <tr class="hide">
                                        ...
                                        <td style="text-align: center;">
                                          ...
                                          <!--  <button class="btn btn-info btn-small" href="" onclick='printSelection(document.getElementById("print<%=vst.getOrderid()%>")); dispatch("clinic_<%=vst.getOrderid()%>");return false'>
                                            ...
                                            <%} else {%>
                                            <button class="btn btn-info btn-small" href="" onclick='printSelection(document.getElementById("print<%=vst.getOrderid()%>"));
                                                                dispatch("print_<%=vst.getOrderid()%>");
                                                                return false'>
                                            ...
                                            <button id="adminprint<%=vst.getVisitid()%>" class="btn btn-info btn-small hide" href="" onclick='printSelection(document.getElementById("print<%=vst.getOrderid()%>"));
                                                                return false'>
                                                <i class="icon-white icon-print"></i> Print Result
                                            </button>
