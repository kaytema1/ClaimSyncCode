                                                        ...
                                                        <table>
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th style="text-align: right;">Quantity Approved</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <%if (items != null) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: right;"><input type="text" style="text-align: right;" class="input-mini pull-right" name="quantity_<%=table.getBatchNumber()%>" value="" id="qty_<%=itt.getRequisitionid()%>"/></td>
                                                                </tr>
                                                                <%}
                                                                }%>
                                                            </tbody>
