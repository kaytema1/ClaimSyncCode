                    ...
                    <div style="display: none;" class="span9 offset3 thumbnail well content1 hide">
                        <table cellpadding="0" cellspacing="0" border="0" class="display example table">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    <td class="patient" rel="popover" data-original-title="<span style='text-align:center;'> <h3>Patient Information Summary </h3> <h5> <b> <%= p.getFname()%>, <%= p.getLname()%> <%= p.getMidname()%> </b></h5> <h5><b> Date of Birth :</b> <%= formatter.format(p.getDateofbirth())%></h5> <span>"
                                    ...
                                    <td>
                                        <div id="d_<%=p.getPatientid()%>" style="display: block">
                                            <a  id="<%=p.getPatientid()%>_patientidlink"  class="btn btn-info" onclick='getType()'> <i class="icon-pencil icon-white"> </i> New Lab Test </a>
                                        </div>
                                        </form>
                                    </td>
                                </tr>
