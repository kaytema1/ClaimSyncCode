...
<% try {
        ...
        if ("forward".equals(request.getParameter("action"))) {
            ...
            PatientBills bills = (PatientBills) mgr.addPatientBills(visit.getVisitid(), patientid, 0, 0, "Full", 0, 0, 0, 0);
            ...
            mgr.updatePatientBills(visit.getVisitid(), mgr.getConsultationId(consultation.getTypeid()).getAmount(), 0, "Debt");
        ...
        if ("Forward to Accounts".equals(request.getParameter("action"))) {
            ...
            String[] copaid = request.getParameterValues("copaidreg[]") == null ? null : request.getParameterValues("copaidreg[]");
            String[] isprivateSupport = request.getParameterValues("isprivateSupportreg[]") == null ? null : request.getParameterValues("isprivateSupportreg[]");
            String patientid = request.getParameter("patient") == null ? "" : request.getParameter("patient");
            ...
            if (patientid != null && !unitName.equals("")) {
                ...
                mgr.updateFolderLocation("pharmacy", unitName, patientid);
                mgr.updateVisitationStatus(visitid, unitName, "pharmacy");
                if (copaid != null) {
