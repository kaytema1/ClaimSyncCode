...
<% try {
        ...
        if ("addbed".equals(request.getParameter("action"))) {
            ...
            try {
                wardName = request.getParameter("name");
                numberOfBeds = request.getParameter("beds");
            ...
            ExtendedHMSHelper mgr = new ExtendedHMSHelper();
            Bed ward = null;
            ward = mgr.addBed(wardName, numberOfBeds);
            String[] roomward = numberOfBeds.split("_");
        ...
        if ("editbed".equals(request.getParameter("action"))) {
            ...
            ExtendedHMSHelper mgr = new ExtendedHMSHelper();
            Bed ward = null;
            ward = mgr.updateBed(bedid, bedname, wardRoom);
