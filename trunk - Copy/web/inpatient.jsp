                ...
                <table class="">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <% if(pdiagnosis!=null && pdiagnosis.size()>0){ for (int u = 0; u < pdiagnosis.size(); u++) {
                            ...
                            <td>
                                <% if(pInvestigation!=null && pInvestigation.size()>0){for (int s = 0; s < pInvestigation.size(); s++) {
                            ...
                            <td>
                                <% if(pTreatment!=null){for (int t = 0; t < pTreatment.size(); t++) {
