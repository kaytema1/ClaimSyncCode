        ...
        <div class="container-fluid">
            ...
            <section style="margin-top: -30px;" id="dashboard">
                ...
                <div class="row">
                    ...
                    <div style="margin-top: 0px; "class="span12 content1 hide">
                        <div class="span12">     
                            <div style="width:100%" class="box" id="myModal">
                                ...
                                <div id="chart_div" style="height: 100%; margin-top: -5px; padding: 0px; z-index: 1000; overflow: hidden; display: block; margin: 0 auto; padding-top: 50px; padding-left: 20px; padding-right: 20px; padding-bottom: 50px;" class="box-body">
                                    ...
                                    <a href="accounts.jsp">
                                        <div class="span3  center  well pull-left large_button ">
                                            <img style="margin-top: -4px;" width= " 36px;" src="images/46.png" />  Records/Cashier
                                        </div> 
                                    </a>
                                    <a href="pharmacy.jsp">
                                        <div class=" span3  pull-left center  well large_button">
                                            <img style="margin-top: -4px;" width= " 36px;" src="images/16.png" />  Dispensary
                                        </div> 
                                    </a>
