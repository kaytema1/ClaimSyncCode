                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td style="text-transform: capitalize; text-align: left"><%=mgr.getPatientFolder(p.getPatientid()).getStatus()%><td>
                                        <div  style="display: block; text-align: left" id="s_<%=p.getPatientid()%>">
                                            <select style="text-transform: capitalize;" class="input-large" name="contype" onchange='showConType("d_<%=p.getPatientid()%>")' id="ty">
        ...
        <div style="max-height: 600px; y-overflow: scroll; display: none;" class="usersummary hide" id="<%= p.getPatientid()%>"  title="Patient Information">
            <div class="thumbnail">
                <ul style="margin-left: 0px; text-transform: uppercase;" class="breadcrumb">
                    <li>
                        <span class="divider"></span> Folder Number:  <b> <%= p.getPatientid()%> </b>
                    </li>
                </ul>
                ...
                <table class="table span3 table-bordered pull-left">
                    <tr>
                        <td> Patient Name</td>
