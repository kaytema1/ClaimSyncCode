            ...
            <header  class="jumbotron subhead" id="overview">
                ...
                <div style="margin-top: 20px; margin-bottom: -50px;" class="subnav navbar-fixed-top hide">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active">
                            <a href="#">Sales Analysis Details <%=staffToUse.getLastname() + " " + staffToUse.getOthername()%> For <%= sponsorToUse.getSponsorname() %></a><span class="divider"></span>
                        </li>
                            ...
                            <form action="labsponsorshipreports.jsp" method="post">
                                <ul style="margin-left: 0px; padding-bottom: 20px;" class="breadcrumb ">
                                    <li style="margin-top: 10px;">
                                        <a style="font-size: 15px;">Sales Analysis Details For <%=staffToUse.getLastname() + " " + staffToUse.getOthername()%> For <%= sponsorToUse.getSponsorname() %> | <%=displayedDate%> </a>
                                    </li>
                                </ul>
                            </form>
                                        ...
                                        for (PaymentObject payment : allPayments) {
                                            ...
                                            if (totalLabPayment > 0) {
                                                ...
                                                if (hashMap.containsKey(labOrderId)) {
                                                    ...
                                                    hashMap.put(labOrderId, "" + count + "_" + price + "_" + patientName + "_" + patientId);

                                                } else {
                                                    price = pmnt;
                                                    hashMap.put(labOrderId, "1_" + price + "_" + patientName + "_" + patientId);
                                                }
                                    ...
                                    <%
                                        if (!hashMap.isEmpty()) {
                                            ...
                                            for (Object key : keys) {
                                                ...
                                                totalAmountPaid += amntPaid;
                                    %>
                                    <tr>

                                        <td style="line-height: 25px; text-transform: uppercase; color: #4183C4;  font-weight: bolder; font-size: 14px;"><%=stringArray[3]%></td>
                                        <td style="line-height: 25px; text-transform: uppercase; color: #4183C4;  font-weight: bolder; font-size: 14px;"><%=key%></td>
                                        <td style="line-height: 25px; text-transform: uppercase; color: #4183C4;  font-weight: bolder; font-size: 14px;"><%=stringArray[2]%></td>
