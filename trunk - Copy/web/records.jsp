                                ...
                                <div id="chart_div" style="height: 100%; margin-top: -5px; padding: 0px; z-index: 1000; overflow: hidden; display: block; margin: 0 auto; padding-top: 50px; padding-left: 20px; padding-right: 20px; padding-bottom: 50px;" class="box-body">
                                    ...
                                    <a href="#">
                                        <div class="span3  center  well large_button registration_dialog_link">
                                            <img style="margin-top: -4px; margin-right: 15px;" width="36px;"height="36px;" src="images/icons/041.png" /> Registration
                                        </div> </a>
                                    <a href="#">
                                    ...
                                    <a href="addappointment.jsp">
                                        <div class="span3 offset1  center well large_button">
                                            <img style="margin-top: -4px; margin-right: 15px;" width="36px;" height="36px;"  src="images/icons/037.png" /> Appointments
                                        </div> </a>
                                    <div class="clearfix"></div>
                                    <!-- <Br />
                                     <Br />
                    ...
                    <div style="max-height: 600px; display: none" id="registration_dialog" title="New Registration">
                        ...
                        <form id="registration" enctype="multipart/data"action="action/registrationaction.jsp" method="POST" class="form-horizontal well">
                            <fieldset>
                                <div style="float: left;" class="pre_first_half">
                                    ...
                                    <div class="control-group gender_group">
                                        ...
                                        <div class="controls">
                                            <select class="MustSelectOpt input-small" name="gender" id="gender">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select class="MustSelectOpt input-medium" name="maritalstatus" id="martialstatus">
                                                <option value="">Select</option>
                                ...
                                <div style="float: left;" class="second">            
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select class="MustSelectOpt text_input" name="country" id="country">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="input-medium" placeholder="Accra" name="city" id="city"/>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="contact" class="input-medium numeric" id="contact"/>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="input-medium numeric" type="text" name="emergencycontact" id="emergencycontact"/>
                                ...
                                <div style="float: left;" class=" third_third">
                                    <div class="control-group">
                                        <label class="control-label" for="ocupation">Occupation*</label>
                                        <div class="controls">
                                            <input class="input-medium" type="text" name="ocupation" id="occupation"/>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select class="MustSelectOpt input-medium" id="payment" name="type">
                                                <option value="">Select</option>
                                    ...
                                    <div class="secondary_payment" style="display: none;">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select class="MustSelectOpt input-medium" id="payment2" name="secondarytype">
                                                    <option value="">Select</option>
                                                    <option id="nhis" value="NHIS" onclick="showInsurance()">National Health Insurance</option>
                                                    <option id="cash" value="CASH" onclick="hideIt()">Out of Pocket </option>
                                                    <option id="private"value="Private" onclick="showMembershipbox()">Private Health Insurance</option>
                                        ...
                                        <div style="display:none;" id="companydiv2">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <select id="coperate2" name="secondarycoperate">
                                                        <option value="">Select</option>
                                                        <%
                            ...
                            <div style="text-align: center;">
                                <button type="submit" name ="action" value="patient" class="btn btn-info btn-small submit_button">
