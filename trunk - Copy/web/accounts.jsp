...
<html>
    <head>
        ...
        <%
            ...
            List visits = mgr.listUnitVisitations("account", dateFormat.format(date));
                                                ...
                                                <div class="center thumbnail">
                                                    ...
                                                    <form action="action/accountsaction.jsp" method="post">
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <% List registration = mgr.getPatientReg(vst.getPatientid());
                                                                    ...
                                                                    if (registration != null && registration.size() > 0) {
                                                                        System.out.println("herehrehrherhe " + registration.size());
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center;">
                                                                    ...
                                                                    <a class ="btn btn-mini btn-danger" style="color: white;" href="#" onclick='showdiscount("discount<%=vst.getVisitid()%>");return false' id="discount<%=vst.getVisitid()%>">Discount</a>
                                                                        ...
                                                                        <section class="hide" id="dashboard">
                                                                            ...
                                                                            <div style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;" class="row center">
                                                                                ...
                                                                                <div class="row center">
                                                                                    ...
                                                                                    <h3 style="font-weight:300; font-size: 13px; letter-spacing: 2px;  margin-top: 5px;text-align: center; width: 100%; letter-spacing: "><% if (registrationFee > 0) {%>REGISTRATION  & <% }%>CONSULTATION</h3>
                                                        ...
                                                        <div style="text-align: center;" class="form-actions">
                                                            <button class="btn btn-small btn-info pull-left" type="button" onclick='printSelection(document.getElementById("print<%=vst.getVisitid()%>")); return false'>
