            ...
            <section style="margin-top: -30px;" id="dashboard">
                ...
                <div class="row">
                    ...
                    <div style="margin-top: 0px; "class="span12 offset3 content1 ">
                        ...
                        <div class="hide span9" id='calendar'></div>
                        <div class="hide" id="dialog">
                            <form class="form-horizontal" action="action/saveAppointment.jsp" name="mainForm"onkeyup="ddd();">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <% if (session.getAttribute("appointmentPatientID") != null) {%>
                                        <input id="patientId" style="text-transform: uppercase; color: #418692;"  type="text" name="patientId" value="<%=session.getAttribute("appointmentPatientID")%>"  />
                                        <% } else {%>
